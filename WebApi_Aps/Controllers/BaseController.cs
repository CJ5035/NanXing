...
namespace WebApi_Aps.Controllers
{
    public class BaseController : ApiController
    {
        ...
        public static LiuShuiHaoService LiuShuiHaoService
        {
            get
            {
                string keyName = "__NanXingAPI_LiuShuiHaoService";
                HttpContext context = HttpContext.Current;
                if (context == null)
                {
                    context = HttpRuntime.Cache.Get("context") as HttpContext;
        ...
        protected static ProductUploadHistoryService ProductUploadHistoryService
        {
            get
            {
                string keyName = "__NanXingAPI_ProductUploadHistoryService";
                //http://stackoverflow.com/questions/6334592/one-dbcontext-per-request-in-asp-net-mvc-without-ioc-container
                if (!HttpContext.Current.Items.Contains(keyName))
                {

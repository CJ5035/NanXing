...
{
    public class WorkshopProcessService
    {
        ...
        {
            return workshopProcessDao.GetIQueryable(whereLambda);
        }
        ...
        {
            return workshopProcessDao.FindById(id, dms);
        }
        #endregion
        ...
        {
            workshopProcessDao.Insert(wsp);
            return workshopProcessDao.SaveChanges();
        }
        ...
        {
            workshopProcessDao.Delete(FindWorkShopProcessById(id, DbMainSlave.Master));
            return workshopProcessDao.SaveChanges();
        }

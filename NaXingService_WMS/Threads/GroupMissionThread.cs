...
namespace NanXingService_WMS.Threads
{
    ...
    public class GroupMissionThread
    {
        ...
        private void MissionToTsj(TiShengJiInfo tsjInfo,AGVMissionInfo agvMission)
        {
            ...
            if (agvMission.Mark==MissionType.InstockType)
            {
                Mark01 = MissionType.MoveIn_TSJ;
                Mark02 = MissionType.InstockType;
            }
            else if(agvMission.Mark == MissionType.MoveOut_TSJ
                || agvMission.Mark == MissionType.MovestockType)
            {
                Mark01 = MissionType.OutstockType;
            ...
            if (agvMission.StartLocation.StartsWith("1"))
            {
                po01 = tsjInfo.TsjPosition_1F;
            }
            else if (agvMission.StartLocation.StartsWith("2"))
            {
                po01 = tsjInfo.TsjPosition_2F;
            }
            else if (agvMission.StartLocation.StartsWith("3"))
            {
                po01 = tsjInfo.TsjPosition_3F;
            }

            if (agvMission.EndLocation.StartsWith("1"))
            {
                po02 = tsjInfo.TsjPosition_1F;
            }
            else if (agvMission.EndLocation.StartsWith("2"))
            {
                po02 = tsjInfo.TsjPosition_2F;
            }
            else if (agvMission.EndLocation.StartsWith("3"))
            {
                po02 = tsjInfo.TsjPosition_3F;
            }
            ...
            floorMission.StartMiddleLocation = string.Empty;
            floorMission.StartMiddlePosition = string.Empty;
            floorMission.EndMiddleLocation = agvMission.EndMiddleLocation;
            floorMission.EndMiddlePosition = agvMission.EndMiddlePosition;

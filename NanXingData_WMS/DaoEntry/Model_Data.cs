...
{    
    ...
    {
        public Model_Data()
            : base("data source=127.0.0.1;initial catalog=NanXingGuoRen_APS;persist security info=True;user id=tzhuser;password=tzhuser;MultipleActiveResultSets=True;App=EntityFramework")
        {
            //this.Database.Log = s =>
            //{
            //    Debug.WriteLine(s);
        ...
        public virtual DbSet<ProPlanOrderheaders> ProPlanOrderheaders { get; set; }
        public virtual DbSet<ProPlanOrderlists> ProPlanOrderlists { get; set; }
        ...
        public virtual DbSet<ProductUploadHistory> ProductUploadHistory { get; set; }
        ...
        {
            modelBuilder.Entity<ItemInfo>().Property(x => x.ConvertRate).HasPrecision(18, 4);

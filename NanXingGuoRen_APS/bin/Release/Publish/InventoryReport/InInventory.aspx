<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InInventory.aspx.cs" Inherits="NanXingGuoRen_WMS.InventoryReport.InInventory" %>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,prosn" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    AllowSorting="true" OnSort="Grid1_Sort" EnableTextSelection="true" SummaryPosition="Bottom" EnableSummary="true" SortField="OrderTime" Title="入库明细"
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="入库日期" Width="200px" LabelWidth="80px"></f:DatePicker>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="MissionNo" SortField="MissionNo" Width="150px" HeaderText="入库单号" ColumnID="MissionNo" />
                       
                        <f:BoundField DataField="OrderTime" HeaderText="入库时间" Width="180px" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}"

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanOrderEdit.aspx.cs" 
    Inherits="NanXingGuoRen_WMS.ProductionOrder_SmallBox.PlanOrderEdit" %>
                            ...
                            <Items>
                                <f:CheckBoxList ID="CheckBoxList6" ColumnNumber="2" runat="server" Width="400px">
                                    <Items>
                                        ...
                                        <f:CheckItem Text="小包装" Value="小包装" />

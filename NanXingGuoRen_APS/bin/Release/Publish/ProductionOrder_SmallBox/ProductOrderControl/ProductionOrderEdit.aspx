<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionOrderEdit.aspx.cs" 
    Inherits="NanXingGuoRen_WMS.ProductionOrder_SmallBox.ProductionOrderEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel runat="server" ID="Panel1" BodyPadding="5px" AutoScroll="true" ShowBorder="false" ShowHeader="false" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPosition="Start">
            <Items>
                <f:Panel runat="server" ShowHeader="false" ID="Panel99" Layout="HBox" Height="100px" Width="100%" Enabled="false" >
                    <Items>
                        ...
                        <f:Panel ID="Panel2" ShowHeader="false" CssClass="" ShowBorder="true" Layout="HBox"
                            ...
                            <Items>
                                <f:CheckBoxList ID="CheckBoxList2" ColumnNumber="1" runat="server" 
                                    ...
                                    <Items>
                                        <f:CheckItem Text="03小包装车间-小袋" Value="03小包装车间-小袋" />
                                        <f:CheckItem Text="03小包装车间-罐" Value="03小包装车间-罐" />
                                        <f:CheckItem Text="03小包装车间-每日坚果" Value="03小包装车间-每日坚果" />
                        ...
                        <f:Panel ID="Panel3" ShowHeader="false" CssClass="" ShowBorder="true" Layout="HBox"
                            ...
                            <Items>
                                <f:CheckBoxList ID="CheckBoxList3" ColumnNumber="1" runat="server" 
                                    ...
                                    <Items>
                                        <f:CheckItem Text="07小包装车间-小袋" Value="07小包装车间-小袋" />
                                        <f:CheckItem Text="07小包装车间-罐" Value="07小包装车间-罐" />
                                        <f:CheckItem Text="07小包装车间-每日坚果" Value="07小包装车间-每日坚果" />
                                    </Items>
                                </f:CheckBoxList>
                            </Items>
                        </f:Panel>
                ...
                <f:Grid runat="server" BoxFlex="1" Title="编辑生产单" ShowHeader="false" ID="Grid1" 
                        ...
                        <f:Toolbar runat="server">
                            <Items>
                                ...
                                <f:DropDownBox runat="server" ID="DropDownBox1" DataControlID="CheckBoxList1" EnableMultiSelect="true" 
                                    Values="" Width="500px" Label="合并单元格" Enabled="false">
                                    <PopPanel>
        ...
        <script>
            ...
            var columnsStr = "Itemno Itemno2 ItemName Spec Unit PcCount PcCount_03_Bag PcCount_03_Tank PcCount_03_Box PcCount_07_Bag PcCount_07_Tank PcCount_07_Box BatchNo BoxNo BoxName CRMPlanList_ID PlanDate Remark PlanTime Priority";
            function OnChange() {

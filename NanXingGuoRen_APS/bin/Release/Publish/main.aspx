<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main.aspx.cs" Inherits="NanXingGuoRen_WMS.main" %>
                                ...
                                <td>
                                    <div style="display:inline; position:absolute">
                                        <f:Label runat="server" Text="南兴天虹生产管理系统" CssStyle="font-size:20px;display:block" Height="38px"
                                           MarginLeft="15px" MarginTop="-15px"  AbsoluteY="0px"></f:Label>
                                        
                                    </div>
                                     <div style="display:inline; position:absolute">
                                        <f:Label runat="server" Text="" CssStyle="font-size:12px;float:left;"
                                            MarginLeft="00px" MarginTop="35px" ></f:Label>
                                    </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="NanXingGuoRen_APS._default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Window ID="Window1" runat="server" IsModal="true" Hidden="false" EnableClose="false"
            ...
            <Toolbars>
                <f:Toolbar runat="server" Position="Bottom" ToolbarAlign="Right">
                    <Items>
                        <f:Button ID="btnRegister" Icon="UserAdd" runat="server" EnablePostBack="false" Text="注册"></f:Button>
        ...
        <f:Window runat="server" ID="window2" Hidden="true" Height="750px" Width="1000px" IsFluid="true" EnableIFrame="true"></f:Window>
    </form>
</body>
</html>

...
namespace NanXingGuoRen_APS
{
    public class NanXingGuoRen_WMSDatabaseInitializer : 
        CreateDatabaseIfNotExists<NanXingGuoRen_WMSContext>
        //DropCreateDatabaseIfModelChanges<NanXingGuoRen_WMSContext>   DropCreateDatabaseAlways<NanXingGuoRen_WMSContext>  DropCreateDatabaseIfModelChanges<NanXingGuoRen_WMSContext>
    {
        protected override void Seed(NanXingGuoRen_WMSContext context)
        {
        ...
        private static List<Menu> GetMenus(NanXingGuoRen_WMSContext context)
        {

<%@ Page Language="C#" AutoEventWireup="true" 
    ...
    Inherits="NanXingGuoRen_WMS.ProductionOrder_SmallBox.PlanOrderControl.PlanToPro" %>
                ...
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,PlanOrderNo" 
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                ...
                                <f:DropDownList runat="server" Label="排产单状态" ID="ddlPlanState" 
                                    ...
                                    <f:ListItem Text="已计划" Value="已计划" Selected="true"/>
                        ...
                        <f:Toolbar runat="server">
                            <Items>
                                ...
                                <f:Button runat="server" ID="btnAddOrder" Icon="DatabaseAdd" Text="合拼生产单"
                                  ConfirmText="确定将选中项合拼生产单？" ConfirmTarget="Top" OnClick="btnAddOrder_Click"></f:Button>

                                  <f:Button runat="server" ID="btnAddPrintOrder" Icon="Printer" Text="合拼并打印生产单"
                                  ConfirmText="确定将选中项合拼并打印生产单？" ConfirmTarget="Top" OnClick="btnAddPrintOrder_Click"></f:Button>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="ItemName" SortField="ItemName" ColumnID="ItemName" 
                            HeaderText="产品名称" Width="500px"/>

                        <f:BoundField DataField="PlanDate" SortField="PlanDate" ColumnID="PlanDate" 
                            HeaderText="计划交货日期" Width="120px" DataFormatString="{0:yyyy-MM-dd}"/>
                        
                        <f:BoundField DataField="PcCount" SortField="PcCount" ColumnID="PcCount" 
                            HeaderText="排产计划数" Width="120px"/>
                        
                        <f:BoundField DataField="BoxNo" SortField="BoxNo" ColumnID="BoxNo" 
                            HeaderText="箱号" Width="120px"/>

                         <f:BoundField DataField="BoxName" SortField="BoxName" ColumnID="BoxName" 
                            HeaderText="箱名" Width="120px"/>

                         <f:BoundField DataField="BoxRemark" SortField="BoxRemark" ColumnID="BoxRemark" 
                            HeaderText="包材备注" Width="150px"/>

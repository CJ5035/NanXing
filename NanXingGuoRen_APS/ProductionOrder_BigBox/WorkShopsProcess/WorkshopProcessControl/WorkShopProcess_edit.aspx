<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkShopProcess_edit.aspx.cs"
    Inherits="NanXingGuoRen_APS.ProductionOrder.WorkShopsProcess.WorkShopProcessControl.WorkShopProcess_edit" %>
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false"  AutoScroll="true" runat="server">
            ...
            <Items>
                <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
                    ...
                    <Items>
                         <f:TextBox ID="tbxName" runat="server" Label="车间工序名称" Required="true" ShowRedStar="true">
                        </f:TextBox>

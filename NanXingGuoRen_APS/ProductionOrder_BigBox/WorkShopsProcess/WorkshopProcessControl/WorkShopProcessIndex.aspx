<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkShopProcessIndex.aspx.cs" 
    Inherits="NanXingGuoRen_APS.ProductionOrder.WorkShopsProcess.WorkShopProcessControl.WorkShopProcessIndex" %>
    ...
    <f:Panel ID="Panel1" runat="server" BodyPadding="5px" 
        ...
        <Items>
            <f:Form ID="Form2" runat="server" Height="36px" BodyPadding="5px" ShowHeader="false"
             ...
             <%--EnableTree="true" TreeColumn="WorkShopName" DataParentIDField="ProcessClass_Id"--%>
            <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                EnableCheckBoxSelect="false"  DataKeyNames="ID" AllowSorting="true"
                OnSort="Grid1_Sort"  SortField="WorkShopSort" SortDirection="ASC" AllowPaging="true"
                IsDatabasePaging="true" OnPreDataBound="Grid1_PreDataBound" OnRowCommand="Grid1_RowCommand"
                OnPageIndexChange="Grid1_PageIndexChange"
                EnableRowGroup="true" DataRowGroupField="processClass.ProcessClassSortName">
                <Toolbars>
                ...
                <Columns>
                    ...
                    <f:BoundField ColumnID="WorkShopName" DataField="WorkShopName" SortField="WorkShopName" Width="200px" HeaderText="工序车间名称" />
                    <f:BoundField DataField="WorkShopSort" SortField="WorkShopSort" Width="150px" HeaderText="工序车间排序" />
                  ...
                  <f:BoundField DataField="processClass.ID" ExpandUnusedSpace="true" HeaderText="备注" />
                   <%--   <f:BoundField DataField="processClass.ID" ExpandUnusedSpace="true" HeaderText="备注" />--%>

                    <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑" WindowID="Window1"
                        Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/ProductionOrder/WorkShopsProcess/WorkshopProcessControl/WorkShopProcess_edit.aspx?id={0}" Width="50px" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMApplyIndex.aspx.cs" Inherits="NanXingGuoRen_APS.ProductionOrder.CRMApplyControl.CRMApplyIndex" %>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <%--SortField="EmergencyDegree"  SortDirection="DESC"
                   --%> 
                <f:Grid runat="server" Title="排产申请单" IsDatabasePaging="true" DataKeyNames="ID,PlanOrder_XuHao,ApplyNoState"
                    AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"   BoxFlex="1" EnableCheckBoxSelect="true"
                    EnableTextSelection="true" SummaryPosition="Bottom" EnableSummary="true" 
                   ...
                   >
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="排产日期" Width="200px" LabelWidth="80px"></f:DatePicker>
                                ...
                                <f:TextBox runat="server" EmptyText="关键词搜索" ID="tbxSearch" MarginLeft="10px"></f:TextBox>
                            </Items>
                        </f:Toolbar>
                        <f:Toolbar runat="server">
                            <Items>
                               <f:TextBox runat="server" Label="申请单号" ID="tbxApplyNo" Width="330px" LabelWidth="80px"></f:TextBox>
                                ...
                                <f:TextBox runat="server" Label="产品名称" ID="tbxName" Width="380px" LabelWidth="80px"></f:TextBox>
                    ...
                    <Columns>
                        ...
                        <f:BoundField ColumnID="crmListStatus" DataField="crmListStatus" SortField="crmListStatus" Width="100px"  HeaderText="任务状态" />
                        ...
                        <f:BoundField ColumnID="OrderDate" DataField="OrderDate" SortField="OrderDate" Width="100px" HeaderText="下单日期"
                         ...
                         <f:BoundField ColumnID="DeliveryDate" DataField="DeliveryDate"  SortField="DeliveryDate"  Width="150px"  HeaderText="交付日期"
                            DataFormatString="{0:yyyy-MM-dd}" />  
                        
                        <f:BoundField ColumnID="ApplyNoState" DataField="ApplyNoState" SortField="ApplyNoState" Width="100px" HeaderText="申请单状态"/>

                       <f:RenderField ColumnID="EmergencyDegree" DataField="EmergencyDegree" SortField="EmergencyDegree" Width="110px" HeaderText="紧急程度"/>
                        ...
                        <f:BoundField ColumnID="ItemName" DataField="ItemName" SortField="ItemName" Width="250px" HeaderText="产品名称"/>
                        <f:BoundField ColumnID="ItemName1" DataField="ItemName1" SortField="ItemName1" Width="200px" HeaderText="产品别名"/>
                        <f:BoundField ColumnID="ItemName2" DataField="ItemName2" SortField="ItemName2" Width="150px"  HeaderText="原料名" />
                        ...
                        <f:BoundField ColumnID="OrderCount" DataField="OrderCount" SortField="OrderCount" Width="100px"  HeaderText="排产数量" />
                        <f:BoundField ColumnID="Unit" DataField="Unit" SortField="Unit" Width="100px"  HeaderText="排产单位" />
                        <f:BoundField ColumnID="Biaozhun" DataField="Biaozhun" SortField="Biaozhun" Width="100px"  HeaderText="标准" />

                        <f:BoundField ColumnID="BatchNo" DataField="BatchNo" SortField="BatchNo" Width="100px"  HeaderText="批号" />
                        <f:BoundField ColumnID="ProductRecipe" DataField="ProductRecipe" SortField="ProductRecipe" Width="100px"  HeaderText="生产配方" />
                        <f:BoundField ColumnID="BoxNo" DataField="BoxNo" SortField="BoxNo" Width="100px"  HeaderText="箱号" />
                        <f:BoundField ColumnID="BoxName" DataField="BoxName" SortField="BoxName" Width="200px"  HeaderText="箱名" />
                        <f:BoundField ColumnID="Remark" DataField="Remark" SortField="Remark" Width="150px"  HeaderText="申请单备注" />


                        <f:BoundField ColumnID="PlanOrder_XuHao" DataField="PlanOrder_XuHao" SortField="PlanOrder_XuHao" Width="150px"  HeaderText="排产单号" />
                        <f:BoundField ColumnID="Jingbanren" DataField="Jingbanren" SortField="Jingbanren" Width="100px"  HeaderText="排产人员" />
                        <f:BoundField ColumnID="PlanDate" DataField="PlanDate" SortField="PlanDate" Width="100px"  HeaderText="排产日期"
                            DataFormatString="{0:yyyy-MM-dd}" />
                       
                        <%--<f:LinkButtonField HeaderText="打印" Width="100px" Icon="Printer" CommandName="Print" Colu<a href="http://localhost:8023/AppModel2/">http://localhost:8023/AppModel2/</a>mnID="print" TextAlign="Center"></f:LinkButtonField>--%>

...
using Quartz;
using Quartz.Impl;
using NanXingGuoRen_APS.AppModel;
...
namespace NanXingGuoRen_APS
{
    public class Global : System.Web.HttpApplication
    {
        ...
        {
            Database.SetInitializer(new NanXingGuoRen_WMSDatabaseInitializer());
            //Database.SetInitializer<NanXingGuoRen_WMSContext>(null);
        ...
        {
            var context = HttpContext.Current.Items["__NanXingGuoRen_WMSContext"] as NanXingGuoRen_WMSContext;
            if (context != null)
            {
                context.Dispose();
            }

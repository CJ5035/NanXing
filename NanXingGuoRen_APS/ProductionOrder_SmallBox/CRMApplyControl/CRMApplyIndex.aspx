<%@ Page Language="C#" AutoEventWireup="true" 
    ...
    Inherits="NanXingGuoRen_APS.ProductionOrder_SmallBox.CRMApplyControl.CRMApplyIndex" %>
                ...
                <f:Grid runat="server" Title="排产申请单" IsDatabasePaging="true"
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="交付日期" Width="200px" LabelWidth="80px"></f:DatePicker>
                            ...
                            <Items>
                               <f:TextBox runat="server" Label="申请单号" ID="tbxApplyNo" Width="330px" LabelWidth="80px"></f:TextBox>
                                ...
                                <f:Button runat="server" ID="btnAddOrder" Icon="DatabaseAdd" Text="合并申请单" OnClick="btnAddOrder_Click"></f:Button>
                                 <f:Button runat="server" ID="btnAddOrder2" Icon="DatabaseAdd" Text="合并申请单2" OnClick="btnAddOrder2_Click"></f:Button>
                    ...
                    <Columns>
                        ...
                        <f:BoundField ColumnID="CRMApplyNo"  DataField="CRMApplyNo" SortField="CRMApplyNo"  Width="150px" HeaderText="CRM申请单号"  EnableLock="true" Locked="true"/>
                        <f:BoundField ColumnID="ItemName" DataField="ItemName" SortField="ItemName" Width="250px" HeaderText="产品名称" EnableLock="true" Locked="true"/>
                        ...
                        <f:BoundField ColumnID="ApplicantName" DataField="ApplicantName" SortField="ApplicantName" Width="120px" HeaderText="申请人" Hidden="true"/>

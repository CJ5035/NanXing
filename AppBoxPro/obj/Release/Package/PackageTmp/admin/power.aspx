<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="power.aspx.cs" Inherits="NanXingGuoRen_WMS.admin.power" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" 
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        <f:RowNumberField />
                        <f:BoundField DataField="GroupName" SortField="GroupName" Width="200px" HeaderText="分组名称" />
                        <f:BoundField DataField="Name" SortField="Name" Width="250px" HeaderText="权限名称" />
                        <f:BoundField DataField="Title" SortField="Title" Width="300px" HeaderText="标题" />

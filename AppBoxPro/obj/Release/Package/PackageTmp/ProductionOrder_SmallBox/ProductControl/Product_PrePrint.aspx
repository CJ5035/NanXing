<%@ Page Language="C#" AutoEventWireup="true"
    ...
    Inherits="NanXingGuoRen_WMS.ProductionOrder_SmallBox.PlanOrderControl.Product_PrePrint" %>
...
<body>
                ...
                <f:Toolbar runat="server" Position="top" ToolbarAlign="Right">
                    <Items>
                        <f:DropDownBox runat="server" ID="DropDownBox1" DataControlID="CheckBoxList1" EnableMultiSelect="true" Values="" Width="700px"
                            ...
                            <PopPanel>
                                <f:SimpleForm ID="SimpleForm2" BodyPadding="10px" runat="server" AutoScroll="true" ShowBorder="true" ShowHeader="false" Hidden="true">
                                    <Items>
            ...
            <Items>
                <f:Grid runat="server" ID="Grid1" CssClass="blockpanel" EnableSummary="false" SummaryPosition="Bottom"
                    ...
                    <Columns>
                        ...
                        <f:BoundField ColumnID="ItemName" DataField="ItemName" SortField="ItemName" Width="200px" HeaderText="产品名称"></f:BoundField>
                        <f:BoundField ColumnID="Spec" DataField="Spec" SortField="Spec" Width="100px" HeaderText="规格"></f:BoundField>
                        ...
                        <f:BoundField ColumnID="PlanOrder_XuHao" DataField="PlanOrder_XuHao"
                            SortField="PlanOrder_XuHao" Width="150px" HeaderText="生产单号" />
    ...
    <script type="text/javascript">
        ...
        function preview() {
            ...
            css += prnhtml;
            //console.log(css);
            f.contentDocument.write(css); //写入到新的iframe窗口
            f.contentDocument.close();
            f.contentWindow.print();
            //window.print();

            //window.document.body.innerHTML = bdhtml;
            ////////var a = "<%%>";//JavaScript中调用C#后台的函数
            //ChangeState()
        ...
        function parseSheet(sheet) {
            ...
            var cssText = "";
            for (var j = 0, le = rules.length; j < le; j++) {
                var rule = rules[j];
                var rc = rule.cssText;
                cssText += rc;

                var styleSheet = rule.styleSheet;//如果rule是@import的样式，那就继续获取它的styleSheet
                if (styleSheet && styleSheet != null && styleSheet.href) {
                    parseSheet(styleSheet);
                }
            }
            cssSheets[href] = cssText;
            return cssText
        };

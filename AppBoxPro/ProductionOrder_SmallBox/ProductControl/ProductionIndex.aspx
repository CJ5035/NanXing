        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" 
                    ...
                    SummaryPosition="Bottom" EnableSummary="true" SortField="Newdate" 
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="下推日期" Width="200px" LabelWidth="80px"/>
                        ...
                        <f:Toolbar runat="server">
                            <Items>
                                <f:TextBox runat="server" Label="生产单号" ID="tbxOrderNo" Width="330px" LabelWidth="80px"></f:TextBox>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="ProductOrderNo"  SortField="ProductOrderNo"
                            ColumnID="ProductOrderNo" HeaderText="生产单号" Width="120px"/>
                        
                        <f:BoundField DataField="Newdate" SortField="Newdate" ColumnID="Newdate" 
                        ...
                        <f:BoundField DataField="Priority" SortField="Priority" ColumnID="Priority"
                         ...
                         <f:BoundField DataField="PcCount" SortField="PcCount" ColumnID="PcCount"
                            HeaderText="排产数量" Width="80px"/>
                        <f:BoundField DataField="NoWorkCount" SortField="NoWorkCount" ColumnID="NoWorkCount"
                            HeaderText="总欠数" Width="80px"/>
                        <f:BoundField DataField="WorkCount" SortField="WorkCount" ColumnID="WorkCount"
                            HeaderText="已生产数" Width="80px"/>
                        <f:BoundField DataField="Present_Work" SortField="Present_Work" ColumnID="Present_Work"
                        ...
                        <f:BoundField DataField="Remark" SortField="Remark" ColumnID="Remark"
                            HeaderText="备注" Width="200px"  Hidden="true"/>

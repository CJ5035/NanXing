<%@ Page Language="C#" AutoEventWireup="true" 
    CodeBehind="ProductCountReport.aspx.cs" 
    Inherits="NanXingGuoRen_WMS.ProductionOrder_SmallBox.ProductControl.ProductCountReport" %>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" 
                    ...
                    SummaryPosition="Bottom" EnableSummary="true" SortField="ItemName" 
                    Title="生产产量报表" SortDirection="DESC" 
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="上报日期" ShowLabel="true" Width="200px" LabelWidth="80px"/>
                    ...
                    <Columns>
                        <f:RowNumberField HeaderText="序号" Width="50px" HeaderTextAlign="Center" 
                            TextAlign="Center"></f:RowNumberField>
                      
                        <f:BoundField DataField="ItemNo"  SortField="ItemNo"
                            ColumnID="ItemNo" HeaderText="产品编码" Width="250px"/>
                         <f:BoundField DataField="ItemName"  SortField="ItemName"
                            ColumnID="ItemName" HeaderText="产品名称" Width="400px"/>
                        ...
                        <f:BoundField DataField="CheJianName"  SortField="CheJianName"
                            ColumnID="CheJianName" HeaderText="车间名称" Width="150px"/>
                        
                        <f:BoundField DataField="PcCount" SortField="PcCount" ColumnID="PcCount"
                            HeaderText="计划生产量" Width="100px" Hidden="true"/>
                         <f:BoundField DataField="AllProCount" SortField="AllProCount" ColumnID="AllProCount"
                            HeaderText="已完成产量" Width="100px"  Hidden="true"/>
                        <f:BoundField DataField="ProCount" SortField="ProCount" ColumnID="ProCount"
                            HeaderText="区间产量" Width="100px"/>
                       
                       
                        <f:BoundField DataField="Unit" SortField="Unit" ColumnID="Unit"
                            HeaderText="单位" Width="60px"/>

                        <f:BoundField DataField="ConvertRate" SortField="ConvertRate" ColumnID="ConvertRate" HeaderText="转换系数" Width="100px"/>

                         <f:BoundField DataField="PcCountOnKg" SortField="PcCountOnKg"
                             ColumnID="PcCountOnKg" HeaderText="计划产量(kg)"
                             Width="100px" Hidden="true"/>

                          <f:BoundField DataField="AllProCountOnKg" SortField="AllProCountOnKg"
                              ColumnID="AllProCountOnKg" HeaderText="已完成产量(kg)" Width="120px"
                              DataFormatString="{0:0.00}"  Hidden="true"/>

                            <f:BoundField DataField="ProCountOnKg" SortField="ProCountOnKg"
                              ColumnID="ProCountOnKg" HeaderText="区间产量(kg)" Width="110px"
                              DataFormatString="{0:0.00}"/>

                        <f:BoundField DataField="ProPrecent" SortField="ProPrecent" ColumnID="ProPrecent"
                            HeaderText="完成率" Width="80px" DataFormatString="{0}%" Hidden="true"/>

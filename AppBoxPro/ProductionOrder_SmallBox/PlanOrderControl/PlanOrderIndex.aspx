<%@ Page Language="C#" AutoEventWireup="true" 
    CodeBehind="PlanOrderIndex.aspx.cs" 
    Inherits="NanXingGuoRen_WMS.ProductionOrder_SmallBox.PlanOrderControl.PlanOrderIndex" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,PlanOrderNo" 
                    ...
                    Title="排产计划管理" SortDirection="DESC" 
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="合并时间" Width="200px" LabelWidth="80px"/>
                                <f:DatePicker runat="server" ID="dp2" Label="结束日期" ShowLabel="false" Width="120px"/>
                                <f:DropDownList runat="server" Label="生产状态" ID="ddlPlanState" 
                        ...
                        <f:Toolbar runat="server">
                            <Items>
                                ...
                                <f:Button runat="server" ID="btnDelete" Icon="DatabaseDelete"
                                    ConfirmText="确认删除计划排产单？" ConfirmTarget="Top"
                                    Text="删除排产单" OnClick="btnDelete_Click"></f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="PlanOrderNo"  SortField="PlanOrderNo"
                            ColumnID="PlanOrderNo" HeaderText="排产单号" Width="150px"/>
                        <f:BoundField DataField="DeliveryDate" SortField="DeliveryDate"
                            ColumnID="DeliveryDate" HeaderText="交付日期" 
                            Width="110px" DataFormatString="{0:yyyy-MM-dd}"/>
                        <f:BoundField DataField="JingBanRen"  SortField="JingBanRen" ColumnID="JingBanRen" HeaderText="排产人员" Width="150px"/>

                        <f:BoundField DataField="Optdate" SortField="Optdate" ColumnID="Optdate"
                            HeaderText="合并时间" 
                            Width="180px" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}"/>
                        <f:BoundField DataField="PlanDate" SortField="PlanDate" ColumnID="PlanDate"
                            HeaderText="计划排产日期" 
                            Width="110px" DataFormatString="{0:yyyy-MM-dd}"/>
                        <f:BoundField DataField="NoWorkCount" SortField="NoWorkCount"
                            ColumnID="NoWorkCount" HeaderText="排产计划数" Width="120px"/>
                        <f:BoundField DataField="ItemNameStr" SortField="ItemNameStr"
                            ColumnID="ItemNameStr" HeaderText="产品名称" Width="300px"/>
                        <f:BoundField DataField="Workshops" SortField="Workshops" ColumnID="Workshops"
                            HeaderText="排产车间" Width="250px"/>
                        
                        <%--<f:LinkButtonField HeaderText="打印" Width="100px" Icon="Printer" CommandName="Print" ColumnID="print" TextAlign="Center"/>--%>
                        <f:BoundField DataField="ProductState" SortField="ProductState" ColumnID="ProductState" HeaderText="排产单状态" Width="130px" hidden="true"/>
                        <f:RenderField DataField="Remark" SortField="Remark" ColumnID="Remark"
                            HeaderText="排产单备注" Width="180px" RendererFunction="renderMajor" />
                        
                         <f:BoundField DataField="CRMHeadNo" SortField="CRMHeadNo" ColumnID="CRMHeadNo"
                            HeaderText="CRM申请单号" Width="120px" />
                        <f:BoundField DataField="CRMXuHao" SortField="CRMXuHao" ColumnID="CRMXuHao"
                            HeaderText="CRM行内码" Width="180px" />
        ...
        <f:Window runat="server" ID="Window2" EnableIFrame="true" Height="900px" Width="1600px" Title="" Hidden="true" 

...
{
    public partial class OrderReport : PageBase
    {
        //key-列名  value-值
        ...
        private void BindGrid1()
        {
            ...
            string sql = string.Format(
                @"select a.*,b.count,b.optdate from 
                 ( select danjuhao,proname,a.spec,a.unit,count(prosn) procount,itemno
                   from Production a 
                   group by danjuhao ,proname,a.spec,a.unit,itemno
                  )a
                  ...
                  and b.optdate between '{3}' and '{4}' and
                    a.proname like '%{0}%' and a.spec like '%{1}%' 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderMingXi.aspx.cs" Inherits="NanXingGuoRen_WMS.ProductionOrder.OrderMingXi" %>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="id,prosn" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    AllowSorting="true" OnSort="Grid1_Sort" EnableTextSelection="true" SummaryPosition="Bottom" EnableSummary="true" SortField="optdate" Title="排产状况"
                    SortDirection="ASC" EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick" OnRowCommand="Grid1_RowCommand"
                    BoxFlex="1" EnableCheckBoxSelect="true">
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="录入日期" Width="200px" LabelWidth="80px"></f:DatePicker>
                                ...
                                <f:TextBox runat="server" Label="产品名称" ID="tbxProname" Width="200px" LabelWidth="80px"></f:TextBox>
                                 ...
                                 <f:TextBox runat="server" Label="转产单号" ID="tbxBatchNo" Width="200px" LabelWidth="80px"></f:TextBox>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="danjuhao" SortField="danjuhao" Width="150px" HeaderText="排产单号" ColumnID="danjuhao" />
                       
                        <f:BoundField DataField="optdate" HeaderText="排产时间" Width="150px" DataFormatString="{0:yyyy-MM-dd}"
                            SortField="optdate" ColumnID="optdate" Hidden="true"></f:BoundField>
                      <%--<f:BoundField DataField="EndLocation" SortField="EndLocation" Width="120px" HeaderText="入库仓位" ColumnID="EndLocation"></f:BoundField>--%>
                     ...
                     <%--   <f:RenderField HeaderText="生产车间" DataField="positionClass" SortField="positionClass" ColumnID="positionClass">
                       ...
                       <f:BoundField DataField="proname" SortField="proname" Width="300px" HeaderText="产品名称" ColumnID="proname"></f:BoundField>
                        <f:BoundField DataField="zhuanhuandan" SortField="zhuanhuandan" Width="150px" HeaderText="转产单号" ColumnID="zhuanhuandan"></f:BoundField>
                        ...
                        <f:RenderField DataField="count" SortField="count" Width="100px" HeaderText="计划数量" ColumnID="count" FieldType="Float" RendererFunction="RenderPrice" SummaryType="Sum"></f:RenderField>
                        <f:RenderField DataField="procount" SortField="procount" Width="100px" HeaderText="入库数量" ColumnID="procount" FieldType="Float" RendererFunction="RenderPrice" SummaryType="Sum"></f:RenderField>
                          
                        <f:BoundField DataField="prodate" HeaderText="入库时间" Width="150px" DataFormatString="{0:yyyy-MM-dd}"
                            SortField="prodate" ColumnID="prodate"></f:BoundField>
                        <f:BoundField DataField="remark1" SortField="remark1" Width="150px" HeaderText="备注" ColumnID="remark1" ExpandUnusedSpace="true"></f:BoundField>

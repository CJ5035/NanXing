<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderReport.aspx.cs" Inherits="NanXingGuoRen_WMS.ProductionOrder.OrderReport" %>
            ...
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="id,prosn" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="optdate" HeaderText="录入时间" Width="150px" DataFormatString="{0:yyyy-MM-dd}"
                            SortField="optdate" ColumnID="optdate"></f:BoundField>
                     ...
                     <%--   <f:RenderField HeaderText="生产车间" DataField="positionClass" SortField="positionClass" ColumnID="positionClass">
                       ...
                       <f:BoundField DataField="proname" SortField="proname" Width="300px" HeaderText="产品名称" ColumnID="proname"></f:BoundField>
                        <f:BoundField DataField="zhuanhuandan" SortField="batchNo" Width="150px" HeaderText="转产单号" ColumnID="zhuanhuandan" Hidden="true"></f:BoundField>
                        ...
                        <f:RenderField DataField="procount" SortField="procount" Width="100px" HeaderText="生产数量" ColumnID="procount" FieldType="Float" RendererFunction="RenderPrice" SummaryType="Sum"></f:RenderField>

...
namespace NanXingGuoRen_WMS.ProductionOrder.CRMApplyControl
{
    public partial class CRMApplyIndex : PageBase
    {
        ...
        private void LoadData()
        {
            ...
            dp2.SelectedDate = DateTime.Now.AddDays(1);
            BindGrid1();
        }
        ...
        protected void btnAddOrder_Click(object sender, EventArgs e)
        {
            ...
            PageContext.RegisterStartupScript(
                 Window2.GetShowReference("~/ProductionOrder/CRMApplyControl/CRMApplyNew.aspx?ids=" + string.Join(",", ids.ToArray()), "合并排产单"));

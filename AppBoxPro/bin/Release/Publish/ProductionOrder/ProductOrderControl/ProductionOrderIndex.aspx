<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionOrderIndex.aspx.cs" Inherits="NanXingGuoRen_WMS.ProductionOrder.ProductOrderControl.ProductionOrderIndex" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,ProductOrderNo" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="ProductOrderNo"  SortField="ProductOrderNo" ColumnID="ProductOrderNo" HeaderText="排产单号" Width="250px"/>

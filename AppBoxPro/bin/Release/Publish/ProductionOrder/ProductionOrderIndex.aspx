<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionOrderIndex.aspx.cs" Inherits="NanXingGuoRen_WMS.ProductionOrder.ProductionOrderIndex" %>
            ...
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,prosn" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                ...
                                <f:DropDownList runat="server" Label="工序分类" ID="ddlPositionClass" AutoSelectFirstItem="false" EnableEdit="true" Width="200px" LabelWidth="80px">
                                ...
                                <f:TextBox runat="server" EmptyText="关键词搜索" ID="tbxSearch"></f:TextBox>
                            </Items>
                        </f:Toolbar>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="optdate" HeaderText="下单日期" Width="200px" DataFormatString="{0:yyyy-MM-dd}" SortField="optdate" ColumnID="optdate"></f:BoundField>
                        <%--<f:BoundField DataField="orderNo" SortField="orderNo" Width="220px" HeaderText="排产单号" ColumnID="provider" />--%>
                         <f:BoundField DataField="prosn" HeaderText="排产单号" Width="250px" SortField="prosn" ColumnID="prosn"></f:BoundField>
                        <f:RenderField HeaderText="排产车间" DataField="positionClass" SortField="positionClass" ColumnID="positionClass" Width="250px">
                        </f:RenderField>
                        ...
                        <f:BoundField DataField="boxName" SortField="boxName" Width="90px" HeaderText="箱名" ColumnID="boxName"></f:BoundField>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionOrderNew.aspx.cs" Inherits="NanXingGuoRen_WMS.ProductionOrder.ProductionOrderNew" %>
            ...
            <Items>
                ...
                <f:Grid runat="server" BoxFlex="1" Title="新增生产单" ShowHeader="false" ID="Grid1" ClicksToEdit="1" 
                    ...
                    <Columns>
                        ...
                        <f:RenderField HeaderText="数量" DataField="count" ColumnID="count" ID="count" FieldType="Float" SummaryType="Sum">
                            <Editor>
                       ...
                       <f:RenderField HeaderText="备注（换行用；分号分隔）" DataField="remark1" ColumnID="remark1" ExpandUnusedSpace="true" MinWidth="200px" >
                           <Editor>

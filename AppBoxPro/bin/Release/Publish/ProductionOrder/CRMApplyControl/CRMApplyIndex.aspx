<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMApplyIndex.aspx.cs" Inherits="NanXingGuoRen_WMS.ProductionOrder.CRMApplyControl.CRMApplyIndex" %>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <%--SortField="EmergencyDegree"  SortDirection="DESC"
                   --%> 
                <f:Grid runat="server" Title="排产申请单" IsDatabasePaging="true" DataKeyNames="ID,ProductOrder_XuHao,ApplyNoState"
                   ...
                   >
                    ...
                    <Columns>
                       ...
                       <f:RenderField ColumnID="EmergencyDegree" DataField="EmergencyDegree" SortField="EmergencyDegree" Width="110px" HeaderText="紧急程度"/>
                        ...
                        <f:BoundField ColumnID="ProductOrder_XuHao" DataField="ProductOrder_XuHao" SortField="ProductOrder_XuHao" Width="150px"  HeaderText="排产单号" />

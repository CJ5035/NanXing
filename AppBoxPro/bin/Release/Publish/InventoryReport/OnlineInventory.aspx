<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnlineInventory.aspx.cs" Inherits="NanXingGuoRen_WMS.InventoryReport.OnlineInventory" %>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,prosn" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    AllowSorting="true" OnSort="Grid1_Sort" EnableTextSelection="true" SummaryPosition="Bottom" EnableSummary="true" SortField="prodate" Title="库存报表"
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="批次日期" Width="200px" LabelWidth="80px"></f:DatePicker>
                                ...
                                <f:TextBox runat="server" EmptyText="关键词搜索" ID="tbxSearch" Label="关键词搜索"></f:TextBox>
                    ...
                    <Columns>
                        ...
                        <f:LinkButtonField HeaderText="入库" Width="60px" Icon="Add" CommandName="Instock" ColumnID="Instock" HeaderTextAlign="Center" TextAlign="Center" Hidden="true"></f:LinkButtonField>
                        <f:BoundField DataField="prodate" HeaderText="批次日期" Width="120px" DataFormatString="{0:yyyy-MM-dd}" SortField="prodate" ColumnID="prodate"></f:BoundField>
                        <%--<f:BoundField DataField="orderNo" SortField="orderNo" Width="220px" HeaderText="排产单号" ColumnID="provider" />--%>
                     ...
                     <%--   <f:RenderField HeaderText="生产车间" DataField="positionClass" SortField="positionClass" ColumnID="positionClass">
                       ...
                       <f:BoundField DataField="proname" SortField="proname" Width="300px" HeaderText="产品名称" ColumnID="proname"></f:BoundField>
                        ...
                        <f:RenderField DataField="allCount" SortField="allCount" Width="110px" HeaderText="库存数量" ColumnID="allCount" FieldType="Float" RendererFunction="RenderPrice" SummaryType="Sum"></f:RenderField>
                        <f:RenderField DataField="usCount" SortField="usCount" Width="110px" HeaderText="可用数量" ColumnID="usCount" FieldType="Float" RendererFunction="RenderPrice" SummaryType="Sum"></f:RenderField>
                           
                        <f:BoundField DataField="color" SortField="color" Width="90px" HeaderText="颜色" ColumnID="color"></f:BoundField>
                        <f:BoundField DataField="boxName" SortField="boxName" Width="90px" HeaderText="箱名" ColumnID="boxName" Hidden="true"></f:BoundField>
                        <f:RenderField HeaderText="状态/配料号" ID="ingredients" DataField="ingredients" ColumnID="ingredients"  Hidden="true"></f:RenderField>
                        <f:BoundField DataField="probiaozhun" SortField="probiaozhun" Width="150px" HeaderText="产品标准" ColumnID="probiaozhun"></f:BoundField>

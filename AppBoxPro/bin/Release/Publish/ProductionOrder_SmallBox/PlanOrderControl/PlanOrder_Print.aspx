<%@ Page Language="C#" AutoEventWireup="true" 
    CodeBehind="PlanOrder_Print.aspx.cs" 
    Inherits="NanXingGuoRen_WMS.ProductionOrder_SmallBox.PlanOrder_Print" %>
            ...
            <Items>
                <f:Grid runat="server" ID="Grid1" CssClass="blockpanel"  EnableSummary="false" SummaryPosition="Bottom"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="name" SortField="name" Width="130px" HeaderText="产品名称" ColumnID="name"></f:BoundField>

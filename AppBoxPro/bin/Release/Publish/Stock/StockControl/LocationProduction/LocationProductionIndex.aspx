<%@ Page Language="C#" AutoEventWireup="true"
    CodeBehind="LocationProductionIndex.aspx.cs"
    Inherits="NanXingGuoRen_WMS.Stock.StockControl.LocationProduction.LocationProductionIndex" %>

<%@ Register Src="~/Stock/StockControl/LocationProduction/ImageLabel_UC.ascx"
                ...
                <f:Region ID="Region1" ShowBorder="false" ShowHeader="false" RegionPosition="Left" BodyPadding="0 5 0 0"
                    ...
                    <Items>
                        ...
                        <f:Panel ShowHeader="false" BodyPadding="5px" ShowBorder="true"
                            ...
                            <Items>
                                <f:Panel runat="server" BoxFlex="1" Title="07一楼"
                                    ...
                                    <Items>
                                        <f:UserControlConnector runat="server">
                                            <uc1:ImageLabel_UC runat="server" ID="ImageLabel_UC1"
                                                ...
                                                Title="已用仓位" TitleColor="#C00000" TitleSize="15px"
                                       ...
                                       <%-- <f:Panel runat="server" BoxFlex="1" ShowHeader="false" ShowBorder="false"
                                        ...
                                        <f:UserControlConnector runat="server">
                                            <uc1:ImageLabel_UC runat="server" ID="ImageLabel_UC2"
                                                ...
                                                Title="空闲仓位" TitleColor="#2b9464" TitleSize="15px"
                                                Value="3333" ValueColor="#2b9464" ValueSize="18px" />
                                        </f:UserControlConnector>
                                    </Items>
                                </f:Panel>
                                <f:Panel runat="server" BoxFlex="1" Title="07二楼" ShowBorder="false"
                                    Layout="HBox" ShowHeader="true">
                                ...
                                <f:RegionPanel ID="RegionPanel2" ShowBorder="false" Margin="0px" runat="server" BoxFlex="1">
                                    <Regions>
                                        <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" RegionPosition="Left" BodyPadding="0 5 0 0"
                                            ...
                                            <Items>
                                                <f:Grid ID="Grid2" ShowBorder="true" ShowHeader="true" Title="仓库" runat="server"
                                        ...
                                        <f:Region ID="Region4" ShowBorder="false" ShowHeader="false" RegionPosition="Left" BodyPadding="0 0 0 0"
                                            ...
                                            <Items>
                                                ...
                                                <f:Grid ID="Grid3" ShowBorder="true" ShowHeader="true" Title="库区" runat="server"
                        ...
                        <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="true"
                            ...
                            <Toolbars>
                                <f:Toolbar runat="server">
                                    <Items>
                                        <f:TextBox runat="server" ID="tbx_WlNo" Label="WMS仓位"
                            ...
                            <Columns>
                                ...
                                <f:BoundField Width="100px" ColumnID="WareLocaNo" DataField="WareLocaNo"
                                    HeaderText="WMS库位号"  />

                                <f:BoundField Width="100px" ColumnID="WareLoca_Lie" DataField="WareLoca_Lie"
                                    HeaderText="WMS库位号" Hidden="true"/>
                                ...
                                <f:WindowField ColumnID="editField" TextAlign="Center" Icon="ApplicationEdit"
                                    ...
                                    DataIFrameUrlFormatString="~/Stock/StockControl/LocationProduction/LocationEdit.aspx?id={0}"
                                    Width="50px" />

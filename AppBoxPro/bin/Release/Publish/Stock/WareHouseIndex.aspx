<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WareHouseIndex.aspx.cs" Inherits="NanXingGuoRen_WMS.Stock.WareHouseIndex" %>
            ...
            <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                ...
                <Columns>
                    ...
                    <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑" WindowID="Window1"
                        Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Stock/WareHouse_edit.aspx?id={0}" Width="50px" />

                ...
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,PlanOrderNo" 
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="计划排产日期" Width="220px" LabelWidth="110px"/>
                    ...
                    <Columns>
                        ...
                        <f:RenderField  DataField="Spec" SortField="Spec" ColumnID="Spec" 
                            HeaderText="规格" Width="100px" RendererFunction="renderMajor"/>
